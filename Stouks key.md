...
title.Text = "Stouks X Key System"
...
SubmitButton.MouseButton1Click:Connect(function()
    ...
    if KeySystem == "Ai121Sf" then   
screenGui:Destroy()
 
loadstring(game:HttpGet("https://raw.githubusercontent.com/Lucashgdhhyy/stouks-V0.1-2hub/main/README.md"))()
  
  end
end)
 
GetKeyButton.MouseButton1Click:Connect(function()
 setclipboard("Not Have link:c") 
end) 
